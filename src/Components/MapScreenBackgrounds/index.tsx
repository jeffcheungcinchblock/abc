...
const MapScreenBackgrounds = ({ uri, screenName, children }: ScreenBackgroundsProps) => {
...
MapScreenBackgrounds.defaultProps = {}

export default MapScreenBackgrounds
