...
const RegistrationCompletedScreen: FC<StackScreenProps<AuthNavigatorParamList, RouteStacks.registrationCompleted>> = (
    ...
    return (
        <ScreenBackgrounds
            screenName={RouteStacks.registrationCompleted}
        >
            ...
            >
                ...
                <View style={[{
                    ...
                    <View style={[CONTENT_ELEMENT_WRAPPER, { flexBasis: 60, alignItems: "center" }]}>
                        <Text style={[{ color: colors.brightTurquoise, fontFamily: "Poppins-Bold", fontStyle: "italic", fontSize: 30 }, Fonts.textLeft]}>
                            {t('congrats')}
                        </Text>
                    </View>
