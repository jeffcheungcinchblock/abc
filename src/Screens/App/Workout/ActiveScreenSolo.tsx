...
const ActiveScreenSolo: FC<WorkoutScreenScreenNavigationProp> = ({
  navigation,
  route,
}) => {
            ...
            <View style={[styles.rowContentContainer2]}>
              <View style={[styles.contentContainer]}>
                <Pressable>
                  ...
                  <WhiteText
                    style={[
                      { lineHeight: 30, fontSize: 30, fontWeight: "bold" },
                    ]}
                  >
              ...
              <View style={[styles.contentContainer]}>
                <Pressable onPress={chanageSpeedUnit}>
                  <Image
                    source={SpeedIcon}
                    style={{
                      width: 30,
                  ...
                  <View style={[styles.rowContentContainer]}>
                    ...
                    <CrystalText style={{ lineHeight: 30, fontSize: 15 }}>
                      {speedUnit}
                    </CrystalText>
                  </View>
                </Pressable>
