...
const HomeInviteStateScreen: FC<HomeInviteStateScreenNavigationProp> = ({ navigation, route }) => {
  ...
  return (
    <ScreenBackgrounds screenName={RouteStacks.homeInviteState}>
      <KeyboardAwareScrollView contentContainerStyle={[Layout.fill, Layout.colCenter]}>
        ...
        <View style={[Layout.fullWidth, Layout.center, { flex: 1, justifyContent: 'flex-start' }]}>
          <TurquoiseButton onPress={onConfirmPress} text={t('confirm')} containerStyle={Layout.fullWidth} />
        </View>
