export default {
  ...
  FitEvoBetaDesc: "FitEvo Beta is for FITamins to start early earning before project launch. Our team strives for a simplistic earning process with a user friendly interface. Please enjoy and let us know how you think! Below are the details for the beta features, including referral program and KE points earning!",
  dailyLogIn: "Daily log-in to earn more KE points",
  whatIsKE: "What is KE points?",
  ...
  KEPointsTransfer: "KE points can be transferred into $BPM after token launch",
