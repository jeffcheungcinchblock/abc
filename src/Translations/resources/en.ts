export default {
  ...
  FitEvoBetaDesc:
    'FitEvo Beta is for FITamins to start early earning before the project launch. Our team strives for a simplistic earning process with a user-friendly interface. Please enjoy and let us know how you think! Below are the details for the beta features, including the referral program and KE points earning!',
  dailyLogIn: 'Daily log-in to earn more KE points',
  whatIsKE: 'What is a KE point? / What are KE points?',
  KEDesc:
