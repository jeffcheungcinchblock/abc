export default {
  ...
  enterInvitationCodeDesc: "We are working hard to make FitEvo ready for everybody and we are building up our community eco-system carefully and responsibly, thus referral code is required to enter the game",
