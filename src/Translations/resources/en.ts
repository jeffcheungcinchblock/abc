export default {
  ...
  moreBonus: 'Refer to earn more KE points!',
  ...
  createNewPasswordPrompt: 'Create your new password below!',
  ...
  totalKEPoints: 'KE Balance',
  earnKEPointsBy: 'Earn KE points by Running and Referring friends!',
  enterInvitationCodeDesc: "Sign up with a referral code to get extra KE points for both yourself and your friend! Let's move together!",
  ...
  whatIsFitEvoBeta: 'What is the Referral about?',
  FitEvoBetaDesc: 'Refer your friends, get bonus KE points and start your FitEvo experience before anyone else!',
  dailyLogIn: 'Daily log-in to earn more KE points',
  whatIsKE: 'What is KE point for?',
  howToEarnKe: 'What if i want more KE points?',
  KEDesc:
    "KE point stands for Kinetic Energy and it's also the secondary token ($KEP) of FitEvo! It indicates your activeness in pursuing a healthy lifestyle and your passion towards Move-To-Earn with FitEvo!",
  inGameToken: 'In-Game token — Early bird EARN more!',
  KEPointsTransfer: 'KE points ($KEP) is the Secondary Token of FitEvo.',
  NFTCompanions: 'NFT Companions - Get your Special NFT Resources',
  NFTMint: 'The NFT Resources will be purchased by $KEP.',
  exclusiveDrops: 'Exclusive Drops - Guaranteed benefits',
  higherKE: 'Higher Global KE Ranking to get extra airdrops and in-app resources.',
  ...
  unlockGameAccess: 'Unlock functions, enjoy the full app experience and fitness journey!',
  ...
  modalPrompt: {
    ...
    ruleOfReferral: 'Rules of referral',
    ...
    // globalRanking: 'Global Ranking',
    climbGlobalRanking: 'Climb your Global Ranking to earn extra rewards and unlock exclusive access to our early preview!',
    // kePointPopup:
    //   'Improve your Global ranking to earn extra rewards and unlock exclusive access to our early preview. Earn more KE points every day by running or referring friends! Global Average KE.',
  },
  error: {
  ...
  selectExerciseMode: 'FITamin, please select your exercise mode!',
  marketplace: 'Marketplace',
  globalAvgKePoints: 'Global Average KE points',
  back: 'Back',
}
